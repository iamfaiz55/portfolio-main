...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://shaikhfaiz.top/about",
    siteName: "Inficom Solutions",
    images: [
      {
        url: "https://shaikhfaiz.top/og-image.jpg", // replace with your logo/banner
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://shaikhfaiz.top/og-image.jpg"], // replace
  },
  alternates: {
    canonical: "https://shaikhfaiz.top/about",
  },
};
